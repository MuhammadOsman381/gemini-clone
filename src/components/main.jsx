...
function Main(props) {
  ...
  return (
    ...
    <div className="  w-[100vw] h-[88.5vh]  flex flex-col items-center justify-center  m-[0px] p-[0px] gap-[0%] max-sm:h-[80vh] max-sm:gap-[0vh]" >
      <div className='-green-200 flex flex-row w-auto h-auto gap-[0vw]'>
     
        <div id="greet" className=" w-[100vw] h-[63vh] flex flex-col items-center  justify-center  m-[0px] p-[0px]  max-sm:h-[65vh] ">
      ...
      <div className=' flex flex-col items-center justify-center w-auto h-auto mt-[0vw]'>
          ...
          <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: "4", delay: "0" }} className='  paragraph overflow-scroll h-[63vh] w-[75vw] text-[3.2vh] gap-[0vw]  flex flex-col   hidden  max-sm:w-[45vh]  max-sm:h-[60vh] '>
          {loader ? 
               ( <Loader/> )
               : updated
              }
      ...
      <div className=' border-t h-[20vh] w-[100vw] flex flex-row items-center justify-center max-sm:h-[15vh]'>
        < motion.input animate={{ y: [0, -20, 0] }} transition={{ duration: "4", delay: "0" }} type="text" className="text -none w-[45vw] h-[3.5rem]  bg-[#444746] text-[#b5b9be] outline-none p-[1.5vw] max-sm:h-[7vh] max-sm:w-[36vh] max-sm:p-[2vh]" onChange={handler} placeholder="Enter a prompt here" />
        <motion.button type='submit' animate={{ y: [0, -20, 0] }} transition={{ duration: "4", delay: "0" }} className="btn  w-[5rem] bg-white text-black h-[3.5rem]  max-sm:h-[7vh] max-sm:p-[2vh] max-sm:w-[10vh]" onClick={data}> submit</motion.button> 
      </div>
