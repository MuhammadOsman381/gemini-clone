...
function Main(props) {
  ...
  return (
    ...
    <div className="  w-[100vw] h-[86vh]  flex flex-col items-center justify-center  m-[0px] p-[0px] gap-[0%] max-sm:h-[80vh] max-sm:gap-[0vh] max-lg:h-[80vh]" >
      ...
      <div className=' border-t h-[20vh] w-[100vw] flex flex-row items-center justify-center max-sm:h-[15vh] max-lg:h-[100px]  '>
